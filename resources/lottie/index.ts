...
const StepAFallback = () =>
  dynamic(() => import('../images/step-A-fallback.svg'));
const StepBFallback = () =>
  dynamic(() => import('../images/step-B-fallback.svg'));
const StepCFallback = () =>
  dynamic(() => import('../images/step-C-fallback.svg'));
const StepDFallback = () =>
  dynamic(() => import('../images/step-D-fallback.svg'));
