...
export const FAQS: FAQType[] = [
  ...
  },
  {
    ...
    answer: '디프만 15기는 온/오프라인으로 진행되므로 국내 거주자에 한해 지원 가능합니다.',
  },
  {
    group: '지원 자격',
  ...
  },
  {
    ...
    answer: '5월 4일 서류 지원 마감 후, 5월 15일 중으로 결과 메일을 발송할 예정입니다.',
  },
  {
    group: '면접 관련',
    question: '인터뷰는 언제 진행되나요?',
    answer:
      '5월 18일 (토) ~ 5월 19일 (일) 이틀간 진행됩니다. 서류 지원시 오전과 오후중 원하는 시간대를 선택할 수 있어요.',
  },
  {
    group: '면접 관련',
    question: '인터뷰는 어디서, 어떻게 진행되나요?',
    answer:
      '디프만 15기 운영진과 지원자 다대다 온라인 인터뷰로 진행되며 자세한 사항은 서류 합격자에게 안내될 예정입니다.',
  },
  {
    group: '면접 관련',
  ...
  },
  {
    ...
    answer: '꼼꼼히 인터뷰 내용을 확인한 후, 5월 28일 ~ 29일 사이 순차적으로 발송될 예정입니다.',
  },
  {
    group: '활동 관련',
    question: '디프만 15기 정규 세션은 어떻게 진행되나요?',
    answer:
  ...
  },
  {
    ...
    answer:
      '디프만 15기는 6월 1일 토요일 OT를 시작으로 16주 동안 진행될 예정입니다. (9월 14일 종료)',
  },
  {
    group: '활동 관련',
    question: '디프만 15기의 팀 구성이 궁금해요',
    answer:
      '디프만은 총 6개의 팀으로 나뉘어 디자이너, 개발자들이 함께 하나의 서비스를 위해 협업합니다. 팀은 제출하신 서류와 역량을 토대로 15기 운영진이 구성할 예정입니다.',
  },
  {
    group: '활동 관련',
  ...
  },
  {
    ...
    question: '활동비가 있나요?',
    answer:
      '디프만은 비영리 IT 커뮤니티로 15기 운영에 필요한 비용 조달 및 활동 지원을 위해 최종 합격 멤버에 한해 활동비를 걷습니다.',
  },
  {
    group: '활동 관련',
    question: '활동비는 얼마인가요?',
