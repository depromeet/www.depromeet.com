...
const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer:
      '만 19세 이상 성실히 오프라인 정기 모임 및 팀별 회의에 참여 가능하신 분이라면 지원 가능합니다.',
  },
  {
    category: '지원자격',
  ...
  },
  {
    ...
    answer: '디프만 18기는 오프라인 활동 위주로 진행되므로 국내 거주자에 한해 지원 가능합니다.',
  },
  {
    category: '지원자격',
  ...
  },
  {
    ...
    answer:
      '지원 결과는 2월 18일 서류 지원 마감 후, 2월 23일 중으로 결과 메일이 발송될 예정입니다.',
  },
  {
    category: '면접관련',
    question: '인터뷰는 언제 진행되나요?',
    answer: '인터뷰는 2월 28일(토) ~ 3월 2일(월) 이틀간 10시 ~ 17시 중으로 진행될 예정입니다.',
  },
  {
    category: '면접관련',
    question: '인터뷰는 어디서, 어떻게 진행되나요?',
    answer:
      '디프만 18기 운영진과 지원자 다대다 온라인 인터뷰로 진행되며 자세한 사항은 서류 합격자에게 안내될 예정입니다.',
  },
  {
    category: '면접관련',
  ...
  },
  {
    ...
    answer: '인터뷰 내용을 꼼꼼히 확인한 후, 3월 5일(목)에 차례로 발송될 예정입니다.',
  },
  {
    category: '활동관련',
    question: '디프만 18기 정규 세션은 어떻게 진행되나요?',
    answer:
      '디프만은 매주 토요일 오후 2시부터 5시까지 정규 세션을 가집니다. 총 17주간 온라인과 오프라인을 병행하여 만날 예정이에요. 정규 세션외에도 팀원들과 함께 작업하는 시간이 필요하니 반드시 참여 가능한 일정을 확인하고 지원해주세요.',
  },
  {
    category: '활동관련',
    question: '활동 기간은 어떻게 되나요?',
    answer:
      '디프만 18기는 3월 14일(토) OT를 시작으로 17주 동안 진행되며, 마지막 세션은 7월 4일에 종료됩니다.',
  },
  {
    category: '활동관련',
    question: '디프만 18기의 팀 구성이 궁금해요',
    answer:
      '디프만은 총 6개의 팀으로 나뉘어 디자이너, 개발자들이 함께 하나의 서비스를 위해 협업합니다. 팀은 제출하신 서류와 역량을 토대로 18기 운영진이 구성할 예정입니다.',
  },
  {
    category: '활동관련',
  ...
  },
  {
    ...
    question: '활동비가 있나요?',
    answer:
      '디프만은 비영리 IT 커뮤니티로 18기 운영에 필요한 비용 조달 및 활동 지원을 위해 최종 합격 멤버에 한해 활동비를 걷습니다.',
  },
  {
    category: '활동관련',
    question: '활동비는 얼마인가요?',
