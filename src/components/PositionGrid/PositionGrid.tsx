  ...
  const positions = [
    {
      ...
      isActive: true,
      imageConfig: {
        src: '/images/18th/recruit/img_design.svg',
      },
      hoverDescription:
    ...
    },
    {
      ...
      isActive: true,
      imageConfig: {
        src: '/images/18th/recruit/img_android.svg',
      },
      hoverDescription:
    ...
    },
    {
      ...
      isActive: true,
      imageConfig: {
        src: '/images/18th/recruit/img_ios.svg',
      },
      hoverDescription:
    ...
    },
    {
      ...
      isActive: true,
      imageConfig: {
        src: '/images/18th/recruit/img_server.svg',
      },
      hoverDescription:
    ...
    },
    {
      ...
      isActive: true,
      imageConfig: {
        src: '/images/18th/recruit/img_web.svg',
      },
      hoverDescription:
