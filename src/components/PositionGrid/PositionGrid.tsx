  ...
  const positions = [
    {
      ...
      isActive: true,
      backgroundImage: '/images/17th/sliced/i1.png',
      hoverDescription:
    ...
    },
    {
      ...
      isActive: true,
      backgroundImage: '/images/17th/sliced/i2.png',
      hoverDescription:
    ...
    },
    {
      ...
      isActive: true,
      backgroundImage: '/images/17th/sliced/i3.png',
      hoverDescription:
    ...
    },
    {
      ...
      isActive: true,
      backgroundImage: '/images/17th/sliced/i4.png',
      hoverDescription:
    ...
    },
    {
      ...
      isActive: true,
      backgroundImage: '/images/17th/sliced/i5.png',
      hoverDescription:
