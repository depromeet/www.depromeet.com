...
export const POSITION_DESCRIPTION = {
  DESIGN: `서비스 기획부터 UXUI 전반을 맡게 돼요. 디자이너들과 함께 의견을 나누며 하나의 멋진 서비스가 만들어지는 경험을 하고 싶다면? 디자인 외에도 마케팅, 브랜딩, 기획 등에도 관심이 있는 디자이너라면? 21세기 디자이너에게 가장 필요한 역량, 개발자와의 커뮤니케이션! 부족하다고 느낀다면? 디프만 12기 디자이너로 바로 지원하세요 !`,
