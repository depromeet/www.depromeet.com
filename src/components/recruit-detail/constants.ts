...
export const POSITION_DESCRIPTION = {
  ...
  IOS: `뛰어나고 열정이 많은 디자이너와 서버 개발자들과 함께 디프만 기간 동안 치열하게 커뮤니케이션을 하며 iOS 앱 개발 역량은 물론이고 전체적인 시야를 넓힐 수 있어요.<br /> 특히 iOS 포지션 상 디자인과 서버의 중간 다리 역할을 하게 됨으로 만들어가는 서비스에 대해 모든 부분에 있어 주도적이고 핵심적인 참여를 할 수 있어요.<br /><br /> 거기에 완성도 높은 앱스토어 런칭 앱을 개발 할 수 있는 최적의 환경까지!`,
...
export const POSITION_PREFER_LIST = {
  IOS: [
    ...
    'iOS 최신 트렌드를 습득하고 공유하는 것에 즐거움을 느끼시는 분',
  ...
  ANDROID: [
    ...
    '디자이너와 소통하며 좋은 UI/UX 개발에 관심이 많으신 분',
    '성장에 목마른 다른 Android 엔지니어 분',
    '들과 함께 새로운 기술을 공유하고 Android 최신 트렌드를 습득하는데 즐거움을 느끼시는 분',
  ],
  WEB: [
...
const TIPS: Array<{
...
}> = [
  {
    ...
    tip: '책임감을 가지고 프로젝트를 진행해본 경험을 어필하는 것을 추천드립니다.\n 또한 자신의 작업물을 어떤 생각을 가지고 만들었는지, 근거를 논리적으로 말할 수 있으면 좋을 것 같아요.',
  },
  {
    name: '박수연',
    position: POSITION_TYPE.DESIGN,
    classList: [11, 12],
    tip: '자신의 강점을 포트폴리오에 잘 녹여내서 면접에서 어필할 수 있어야해요.\n 그리고 협업에 대해서도 생각해보시길 추천드립니다.',
  },
  {
    name: '이승희',
    position: POSITION_TYPE.DESIGN,
    classList: [11, 12],
    tip: '사이드 프로젝트를 경험하며 이룬 결과 이외에도 그 과정에서 얻은 인사이트를 진솔하게 공유했었어요.\n 협업의 가치에 대해 깊게 생각해 보시고 본인만의 정답을 만들면 좋을 것 같습니다.',
  },
  {
    name: '이종원',
    position: POSITION_TYPE.DESIGN,
    classList: [11, 12],
    tip: '포트폴리오에서의 기획적인 의도나 이유들을 조리있게 설명할 수 있어야 해요!\n 프로젝트 끝까지 참여할 수 있다는 본인의 열정을 어필해주시면 좋을 것 같아요.',
  },
  {
    name: '차요셉',
  ...
  },
  {
    ...
    classList: [12],
    tip: '동아리는 면접 시간이 시간이 짧으니 주어진 시간 안에 나의 장점을 보여줄 수 있도록 전략을 잘 짜셔야 해요.\n 또, 동아리에는 어떤 사람이 필요할까 고민해 보시면 좋을 거예요!',
  },
  {
    name: '김해인',
    position: POSITION_TYPE.ANDROID,
    classList: [12],
    tip: '디프만에서 어떤 가치관과 협업 자세로 꼭 무언가를 해보고 싶다는 열정이 합격의 키포인트가 됐다고 생각합니다.\n 그 열정을 서류와 면접에서 녹여낼 수 있다면 합격할 수 있을 겁니다.',
  },
  {
    name: '전해성',
    position: POSITION_TYPE.ANDROID,
    classList: [12],
    tip: '디프만 활동 및 프로젝트에 참여하면서 제가 얻고싶은 것과 기여할 수 있는 것을\n 구체적으로 적었던 것이 도움이 되었습니다.',
  },
  {
    name: '황규일',
    position: POSITION_TYPE.ANDROID,
    classList: [12],
    tip: '면접때 얼마나 참여를 하고 싶은지 협업 및 프로젝트에 대해서 얼마나 열정이 있는지에 대해서 말했던 것 같아요!!\n 기술질문은 내가 맡은 파트에 대해서 얼마나 관심을 가지고 살펴 봤는지 간단하게 말했었어요.',
  },
  {
    name: '김민수',
    position: POSITION_TYPE.WEB,
    classList: [12],
    tip: '꾸준히 성장하기 위한 발자취를 많이 보여주시면 좋을 것 같아요. 그리고 무엇보다도 중요한 건 책임감이라고 생각합니다.\n 지속적 성장을 위한 꾸준함과 책임감 꼭 기억해주세요!',
  },
  {
    name: '오혜성',
    position: POSITION_TYPE.WEB,
    classList: [11, 12],
    tip: '꾸밈없이 고민했던 경험을 녹이고, 디프만 활동 참여에 열정을 보여주시길 추천해요. 기술적으로는 웹 플랫폼뿐이\n 아닌 다양한 플랫폼에 웹 기술을 이용한 경험을 어필하신다면 좋을 거 같아요.',
  },
  {
    name: '정대윤',
    position: POSITION_TYPE.WEB,
    classList: [11],
    tip: '디프만은 동아리이다 보니 프로젝트와 활동에 참여할 시간, 육체, 정신적 여유가 되는 분을 선호해요!\n 동아리 활동과 프로젝트에 기여할 수 있는 것들을 어필하면 좋을 것 같아요!\n ex) 스터디 활동을 잘해요! 기술적 숙련도가 높아서 리딩할 수 있어요!',
  },
  {
    name: '이성태',
